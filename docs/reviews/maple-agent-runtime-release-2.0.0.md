...
The exact final repository commit is `f88bf9d98f744417442ada87f3dd32aaf8769083`
(`docs(readme): preserve CI quickstart heading`). GitHub CI passed all
required final workflows: Security Scan `33344998929`, Code Quality
`33344998918`, Tests `33344998916`, and aggregate CI `33344998936`.
...
scanning approximately 7.65 MB. Full history covered 749 commits and retained
...
**Candidate:** `f88bf9d` (`docs(readme): preserve CI quickstart heading`)
