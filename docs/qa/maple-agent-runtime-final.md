...
|---|---|---|
| New feature regressions | PASS | 187 LLM/autonomy/CLI tests passed; one existing pytest config warning. |
...
feature-complete for the fifteen implemented capability slices, the built wheel
