...
across 108 tracked test files. Black, Ruff, changed-boundary mypy, compile,
diff, and network-free doctor pass. QA behavior and code review pass. Package
evidence is pending; dependency-governance disposition remains open; no
publication was performed.
