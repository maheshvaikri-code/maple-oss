...
class EncryptionManager:
    ...
    def __init__(self, config: Any) -> None:
        ...
        if CRYPTO_AVAILABLE:
            try:
                ...
                if kp_result.is_ok():
                    ...
                    logger.info(
                        "EncryptionManager initialized with real cryptography "
                        "(AES-256-GCM + RSA4096)"
                    )
                else:
                    logger.warning(
        ...
        if not self._crypto:
            ...
            warnings.warn(
                (
                    "No cryptography library available. EncryptionManager will use "
                    "base64 encoding which is NOT secure. Install with: "
