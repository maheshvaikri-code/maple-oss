...
class CryptographyManager:
    ...
    def generate_key_pair(
        self, key_type: str = "RSA4096"
    ) -> Result[KeyPair, Dict[str, Any]]:
        """
    ...
    def encrypt_data(
        self, data: Union[str, bytes], public_key: Any
        ...
        try:
            ...
            if self.crypto_suite == CryptoSuite.AES256_GCM_RSA4096:
                ...
                return Result.ok(
                    base64.b64encode(json.dumps(result).encode()).decode("utf-8")
                )
    ...
    def decrypt_data(
        self, encrypted_data: str, private_key: Any
    ...
    def sign_data(
        self, data: Union[str, bytes], private_key: Any
    ) -> Result[str, Dict[str, Any]]:
        """
    ...
    def verify_signature(
        self, data: Union[str, bytes], signature: str, public_key: Any
    ...
    def derive_shared_secret(
        self, private_key: Any, peer_public_key: Any
    ) -> Result[bytes, Dict[str, Any]]:
        """
