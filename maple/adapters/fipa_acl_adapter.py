...
class FIPAACLAdapter:
    ...
    def translate_fipa_to_maple(
        self, fipa_message: str
    ...
    def _decode_fipa_content(self, content: str) -> Dict[str, Any]:
        ...
        if content.startswith("MAPLE-ENHANCED:"):
            ...
            # Legacy FIPA content
            return {
                "legacy_fipa_content": content,
                "maple_note": "Upgraded to MAPLE format",
            }
    ...
    def send_to_fipa_agent(
        self, fipa_agent_address: str, maple_message: Message
        ...
        try:
            ...
            return Result.err(
                {"errorType": "FIPA_COMMUNICATION_ERROR", "message": str(e)}
            )
