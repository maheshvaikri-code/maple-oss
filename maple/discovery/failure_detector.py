...
class FailureDetector:
            ...
            if health_result.is_ok():
                ...
                if health.status in ["unhealthy", "degraded"] and health.score < 0.5:
                    failure = FailureEvent(
                        ...
                        timestamp=time.time(),
                        details={"health_score": health.score, "issues": health.issues},
    ...
    def _record_failure(self, failure: FailureEvent):
        ...
        with self._lock:
            ...
            self.failure_history[failure.agent_id] = [
                f
                for f in self.failure_history[failure.agent_id]
    ...
    def _execute_recovery_action(
        self, failure: FailureEvent, recovery_action: RecoveryAction
    ) -> bool:
    ...
    def get_failure_history(
        ...
        with self._lock:
            ...
            recent_failures = [
                failure
                for failure in self.failure_history[agent_id]
    ...
    def get_failure_statistics(self) -> Dict:
        ...
        with self._lock:
            ...
            if successful_recoveries + failed_recoveries > 0:
                recovery_rate = successful_recoveries / (
