...
class ResourceNegotiator:
    ...
    def request_resources(
        ...
        message = Message(
            ...
            payload={"request_id": request_id, "resources": request.to_dict()},
        )
    ...
    def handle_request(
        ...
        if result.is_ok():
            ...
            offer = Message(
                ...
                priority=Priority.HIGH,
                payload={"request_id": request_id, "resources": result.unwrap()},
            )
    ...
    def handle_acceptance(
        self, message: Message, allocator: Callable[[str, Dict[str, Any]], None]
    ) -> Message:
        """
