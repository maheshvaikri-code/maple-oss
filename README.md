...
- **Event Streaming and Redaction (preview)** — Publish bounded sequenced events with ring retention, wait/snapshot consumers, subscriber isolation, recursive credential redaction, and shared sync/async agent lifecycle metadata with usage trailers.
