...
- **Bounded Conversation Sessions (preview)** — Persist JSON-safe turn messages in thread-safe in-memory or atomic file-backed stores with bounded quotas, immutable snapshots, and optimistic version conflicts; model replay and agent binding remain explicit follow-on work.
